...
namespace SpecFlowProjectUsingBDD.StepDefinitions
{
    ...
    public sealed class SpecFlowHooks
    {
        ...
        {
            Console.WriteLine("In Method After Scenario 1");
        }

        [BeforeScenario(Order = 30)]
        public void BeforeScenario3()
        {
            Console.WriteLine("In Method Before Scenario 3");
        }

        [AfterScenario(Order = 30)]
        public void AfterScenario3()
        {
            Console.WriteLine("In Method After Scenario 3");
        }
        ...
        {
            Console.WriteLine("In Method Before Scenario 2");
        }
        ...
        {
            Console.WriteLine("In Method After Scenario 2");
        }

        [BeforeScenarioBlock]
        public void BeforeScenarioBlock()
        {
            Console.WriteLine("In Method Before ScenarioBlock");
        }
